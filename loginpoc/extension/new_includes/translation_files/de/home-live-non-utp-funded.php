...
"hours" => "Stunden",
            ...
            "update-account"=> array(
                "Aktualisieren Sie Ihren Account und platzieren Sie 1 Trade bis Montag, den 21. November 2016 um 10,000 £ zu gewinnen!",
            ...
            "update-steps-container"=> array(
                ...
                array(
                    "title" => "Schritt 2",
                    "info" => "Lesen Sie die neuen Bedingungen"
                ),
                array(
                    "title" => "Schritt 3",
                    "info" => "Aktualisieren Sie einige Basis-Informationen"
                ),
                array(
                    "title" => "Schritt 4",
                    "info" => "Erhalten Sie Ihr kostenloses UTP"
                )
            ),
