...
<body style="color: #36393e" id="utp">
	...
	<div class="tnc-container">	
		...
		<div class="tnc-button-wrapper" style="">
			...
			<a href="/extension/thank-you.php?email=<?php echo getEmailFromCookie(); ?>&lang=<?= $lang ?>" id="agree-button" class="action-button activate-button"><?= $translations[$lang]["text"]["agree"] ?></a>
		</div>
	</div>		
	<?php		
	...
	<script type="text/javascript">
		...
		$("#identifyUser").click(function(event){
			...
			window.location.assign ('/extension/terms-and-condition.php?email='+$('#emailFromPopup').val());
			return false;
		});
	</script>
</body>
