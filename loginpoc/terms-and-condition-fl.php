...
<div class="tnc-container">
    ...
    <div class="tnc-button-wrapper" style="">
        ...
        <a href="/thank-you-fl.php?email=<?php echo getEmailFromCookie(); ?>&lang=<?php echo $lang ?>" id="agree-button" class="action-button activate-button"><?= $translations[$lang]["text"]["agree"] ?></a>
    </div>
</div>
<?php
