...
kinds.forEach(function(kind,kindIndex){
	...
	languages.forEach(function(language) {
		...
		for(var index=0;index<array.length;index+=10) {
			...
			attributes[array[index]][language].data.push(array[index+8]);
			attributes[array[index]][language].data.push(array[index+9]);
		}
		var targetFilePath=mailLocation+kind+"/"+language+".json";
