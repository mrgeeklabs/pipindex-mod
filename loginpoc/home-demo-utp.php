...
<?php
	...
	$defaultTranslationsPath = $_SERVER['DOCUMENT_ROOT'] . "/new_includes/translation_files/$lang/home-demo-utp.php";
...
<?php if ( (!isset($_GET['email']) && !isset($_COOKIE['user_email'])) || (isset($_GET['email']) && $_GET['email'] == "") ) header('LOCATION:http://pipindex.com'); ?>
	...
	<div class="lp3-wrapper">
	    ...
	    <div id="update-account">
	        <p><?= $translations[$lang]["update-account"][0] ?> <b><?= $translations[$lang]["update-account"][1] ?> </b> <?= $translations[$lang]["update-account"][2] ?></p>
