...
class SalseforceHelper {
    ...
    public function FindLeadByEmail($email) {
        $query = "SELECT Id, Consent__c, Count_of_T_C_clicks__c, Count_of_LP_Clicks__c, Count_of_Contact_Us_Clicks__c, Event_Analytics__c, Page_Analytics__c, Phone, Phone_2__c FROM Lead WHERE Email = '" . $email . "' OR Email_2__c = '" . $email . "'";
