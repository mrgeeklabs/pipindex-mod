...
class PHPMailer {
     ...
     * @var string
     */
    public $From              = 'root@smtp.gmail.com';
     ...
     * by SERVER_NAME is used or 'smtp.gmail.com.localdomain'.
     * @var string
     */
    public $Hostname          = '';
    ...
    /**
     * Returns the server hostname or 'smtp.gmail.com.localdomain' if unknown.
     * @access protected
     * @return string
     */
    protected function ServerHostname() {
        if (!empty($this->Hostname)) {
            ...
            $result = 'smtp.gmail.com.localdomain';
        }
